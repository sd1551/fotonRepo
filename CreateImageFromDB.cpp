...
int main(int argc, char* argv[]) {
    ...
    desc.add_options()
        ...
        ("database,d", po::value<std::string>(&dbFile)->default_value("C:\\opencv\\FotonProject\\experiment.db"), "Путь к файлу базы данных")
        ("output,o", po::value<std::string>(&outputImage)->default_value("C:\\opencv\\FotonProject\\tiles_image.png"), "Путь к выходному изображению");
